...
urlpatterns = [
    ...
    path('report_list/likes/<str:likes>', views.report_list, name='report_list_likes'),
    path('report_list/comments/<str:comments>', views.report_list, name='report_list_comments'),
