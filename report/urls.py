...
urlpatterns = [
    ...
    path('reports/category/<int:id>/<slug:slug>/', views.report_list, {"mode": "category"},
         name="report_list_category"),
    ...
    path(
        'report_detail/<int:id>/<slug:slug>/media/images/',
        views.report_media_images,
        name='report_media_images'
    ),

    path(
        'report_detail/<int:id>/<slug:slug>/media/videos/',
        views.report_media_videos,
        name='report_media_videos'
    ),

    path(
        'report_detail/<int:id>/<slug:slug>/media/audios/',
        views.report_media_audios,
        name='report_media_audios'
    ),
]
